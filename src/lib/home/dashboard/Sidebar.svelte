...
<script>
	...
	import { TrendingUp, Home } from 'lucide-svelte';
					...
					<div class="relative">
						...
						>
							...
							<span class="hidden lg:flex lg:items-center">
								<span
									class="ml-4 text-sm font-semibold leading-6 text-gray-600 font-mono md:text-[18px] md:font-light hover:text-gray-900"
									aria-hidden="true"
									>Lofii
								</span>
								<svg
